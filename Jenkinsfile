        ...
        stage('Scan Vulnerabilidade'){
            steps {
                sh '''
                     ...
                     sleep 1
                     DOCKER_IMAGE=$(docker pull eoliveiralorente/api-s3)
                     ...
                     echo "Iniciar clair"
                    ./clair-scanner -c http://docker:6060 --ip $(hostname -i) -r gl-container-scanning-report.json -l clair.log -w clair-whitelist.yml || true
